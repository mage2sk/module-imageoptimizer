<?php
/**
 * Standalone install + heartbeat reporter for Panth_ImageOptimizer.
 *
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_ImageOptimizer';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-imageoptimizer';
