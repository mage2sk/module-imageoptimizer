<?php
/**
 * Daily heartbeat cron for Panth_ImageOptimizer. Skips if Panth_Core is
...
namespace Panth\ImageOptimizer\Cron;

use Magento\Framework\Module\Manager as ModuleManager;
use Panth\ImageOptimizer\Service\InstallReporter;
